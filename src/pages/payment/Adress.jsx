...
//         cartid: cart._id,couponDiscount
//       }, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//       // Update cart with original total
//       setCart(prevCart => ({
//         ...prevCart,
...
//       setAppliedCoupon(null);
//       setCouponCode("");
//       // Recalculate original total by adding back discount
//       const originalTotal = cart.totalPrice + (appliedCoupon?.discountAmount || 0);
//       setCart(prevCart => ({
//         ...prevCart,
...
//                               className="border border-gray-200 rounded-lg p-3 cursor-pointer hover:border-indigo-300 hover:bg-indigo-50"
//                             >
